...
#PREPARE  
**Data Source**  
I will use Cyclistic’s historical trip data to analyze and identify trends from Jan 2022 to Dec 2022 which was provided in the course [link](https://divvy-tripdata.s3.amazonaws.com/index.html).
...
**Combining Data**  
SQL Query: [Data Combining](https://console.cloud.google.com/bigquery?sq=969933669310:9b615c61f2dc47148308dc7e8ee044f9)  
12 csv files are uploaded as tables in the dataset '2022_tripdata'. Another table named "combined_data" is created, containing 5,667,717 rows of data for the entire year.

**Data Exploration**  
SQL Query: [Data Exploration](https://console.cloud.google.com/bigquery?sq=969933669310:f08b7f81c52f42318ec7f8d456e131e0)  
...
#DATA CLEANING  
SQL Query:[Data Cleaning](https://console.cloud.google.com/bigquery?sq=969933669310:155b74b353a44491b27125439c4fdcdc)
...
#ANALYZE AND SHARE  
SQL Query: [Data Analysis](https://console.cloud.google.com/bigquery?sq=969933669310:9f20ba3bbca441f0a0b7fd583e7ffdd6)  
...
![image](Total Trips per Month_Day_Hour.png)
...
![image](Avg Ride Duration per Month_Day_Hour.png)
...
![image](Trips at Start Stations.png)
...
![image](Trips at End Stations.png)
...
3.Start and end their journeys near parks, museums, along the coast and other recreational sites.  


***Member***  
1.Prefer riding bikes on week days during commute hours (8 am / 5pm) in summer and spring.  2.Travel more frequently but shorter rides (approximately half of casual riders' trip duration).  
3.Start and end their trips close to universities, residential and commercial areas.  
